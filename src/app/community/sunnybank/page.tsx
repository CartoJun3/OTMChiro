          ...
          <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
            ...
            <div className="mt-10 grid max-w-xl grid-cols-1 gap-8 text-base/7 text-gray-700 lg:max-w-none lg:grid-cols-2">
              <div>
                ...
                <p className="mt-8">
                We specialize in helping people with posture correction, headaches, neck pain, and back pain, which are common issues that can stem from poor habits, prolonged sitting, or physical strain. In a busy suburb like Sunnybank, where students and professionals spend long hours studying and working, spinal health plays a crucial role in brain function, concentration, and overall academic performance. Our hands-on treatment and movement-based solutions aim to not only reduce pain but also improve nervous system function, helping you stay focused, energized, and at your best.
                </p>
              </div>
              <div>
                <p>
                As a chiro supporting Sunnybank residents, we work with people of all ages: children, teenagers, adults, and grandparents. Whether it’s helping students optimize their brain health and posture for better learning, supporting active teens in sports, assisting professionals in managing work-related strain, or keeping seniors mobile and independent, our personalized approach ensures the right care at every stage of life.
                </p>
                <p className="mt-8">
